		 ...
		 :rightSlot="false" :background-color="[245,245,245]" @scroll="navbarScroll">
			...
			<view class="ctn">
				<view class="searchCtn" :style="{'width':navSearchWidth + '%','background-color':'rgba(230,230,230,'+ navSearchBgOpacity +')'}">
					...
					<i class="hxicon icon-search"></i>
					<input confirm-type="search" class="input" type="text" placeholder="输入搜索关键词" @confirm="confirm" style="font-size: 14px;"
					 :style="{'opacity':navSearchBgOpacity ,'color':navSearchColor}">
				</view>
				<view class="leftBox" style="font-size: 22px;">
					<i class="hxicon icon-favor"></i>
					<i class="hxicon icon-more"></i>
												...
												<view class="m-store-item">
													...
													<view class="m-text">
														...
														<view class="m-distance">
															...
															<hx-number-box @change="addGoodsChange" :value="rowData.number" :rowData="rowData" :clickTime="animaTime + 100"
									...
									<view class="m-store-item">
										...
										<view class="m-text">
											...
											<view class="m-distance">
												...
												<hx-number-box @change="addGoodsChange" :value="rowData.number" :rowData="rowData" :clickTime="animaTime + 100"
												 @addChange="touchOnAddGoods('.addEle2_' + i,rowData)"></hx-number-box>
